/** Public API. Import from `@/domains/devices` outside this domain; relative paths inside. */
...
export {DEVICE_KIND_LABEL, formatWhen, VIEW_MODE_LABEL, VISIT_KIND_LABEL, WALL_LAYOUT_LABEL} from './labels';
